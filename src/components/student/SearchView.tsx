...
export const SearchView: React.FC<SearchViewProps> = ({ data, searchQuery, onProgramPress }) => {
            ...
            <View style={styles.gridContainer}>
                {data.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <ImageBackground
                                source={item.image ? { uri: item.image } : require('../../../assets/dummy/programs/1.png')}
                            ...
                            >
                                ...
                                <View style={styles.cardBottom}>
                                    ...
                                    <View style={styles.progressBarWrapper}>
                                        ...
                                        <View style={[styles.progressDiamond, { left: `${progress}%` }]} />
                                    </View>
                                </View>
                            </ImageBackground>
                        </FocusableCard>
