...
export const HorizontalRow: React.FC<HorizontalRowProps> = ({
  ...
  const showRightArrow =
    contentSize > layoutWidth && contentOffset + layoutWidth < contentSize;
  ...
  const scrollLeft = () => {
    flatListRef.current?.scrollToOffset({
      offset: Math.max(0, contentOffset - layoutWidth / 2),
      animated: true,
    });
  };
      ...
      {showLeftArrow && (
        <TouchableOpacity
          style={[
            styles.sliderButton,
            styles.leftButton,
            focusedButton === 'left' && styles.focusedButton,
          ]}
          onPress={scrollLeft}
        ...
        >
          <SliderIcon
            width={24}
            height={24}
            color={focusedButton === 'left' ? theme.colors.background : 'white'}
      ...
      {showRightArrow && (
        <TouchableOpacity
          style={[
            styles.sliderButton,
            styles.rightButton,
            focusedButton === 'right' && styles.focusedButton,
          ]}
          onPress={scrollRight}
        ...
        >
          <SliderIcon
            ...
            height={24}
            color={
              focusedButton === 'right' ? theme.colors.background : 'white'
            }
          />
        </TouchableOpacity>
      )}
